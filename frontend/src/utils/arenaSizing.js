...
export const estimateOpponentCellSize = (baseCellSize, opponentCount, tallestBoardRows = 20) => {
    ...
    const availablePerCard =
        (paddingAdjustedHeight - spacing * Math.max(opponentCount - 1, 0)) / opponentCount;
