...
describe('ModeSelectPage', () => {
  ...
  it('shows the main menu and toggles to solo selection', () => {
    ...
    fireEvent.click(screen.getByRole('button', { name: /choose a solo game mode/i }));
    ...
    fireEvent.click(screen.getByRole('button', { name: /go back to the previous page/i }));
    expect(screen.getByText('Choose how you want to play')).toBeInTheDocument();
  ...
  it('navigates to the appropriate routes from the main menu', () => {
    ...
    navigateMock.mockReset();
    fireEvent.click(screen.getByRole('button', { name: /view your recent games/i }));
